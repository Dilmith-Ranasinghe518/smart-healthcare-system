...
export default function Home() {
  return (
    <div className="hero-gradient min-h-screen w-screen overflow-x-hidden bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-white flex flex-col transition-colors duration-300">
      {/* Shared Navbar */}
      <Navbar />
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-2 gap-16 items-center pt-16 pb-24 animate-[fadeIn_0.8s_ease-out] flex-1">
        ...
        <div className="flex flex-col items-start">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight leading-[1.05] bg-gradient-to-br from-slate-800 dark:from-white to-slate-500 dark:to-slate-400 bg-clip-text text-transparent">
          ...
          <p className="mt-6 mb-10 text-lg text-slate-600 dark:text-slate-400 max-w-lg leading-relaxed">
        ...
        <div className="relative h-[380px] md:h-[450px] w-full flex items-center justify-center scale-90 md:scale-100 transition-transform duration-300">
          ...
          <div className="glass-panel absolute top-2 left-2 md:top-5 md:left-5 w-56 md:w-60 z-10 float-up bg-white/80 dark:bg-slate-900/85 p-5 md:p-6 animate-[fadeIn_1s_0.2s_backwards]">
            <div className="flex justify-between mb-3 md:mb-4">
              <h4 className="text-xs text-slate-600 dark:text-slate-400">Live Pulse</h4>
          ...
          <div className="glass-panel absolute bottom-5 right-2 md:bottom-8 md:right-5 w-60 md:w-64 z-10 float-down bg-white/80 dark:bg-slate-900/85 p-4 md:p-5 animate-[fadeIn_1s_0.4s_backwards]">
            <div className="flex gap-3 items-center">
              <div className="bg-emerald-500/10 p-1.5 md:p-2 rounded-lg">
                <Clock size={18} className="text-emerald-400" />
              </div>
              <div>
                <p className="text-[10px] md:text-xs text-slate-600 dark:text-slate-400">Next Consultation</p>
                <h4 className="text-xs md:text-sm font-semibold text-slate-800 dark:text-slate-100">Dr. Smith - 14:30</h4>
              </div>
            </div>
          </div>

          {/* Card 3: Main Dashboard Preview Layer */}
          <div className="glass-panel w-[280px] md:w-[320px] h-[260px] md:h-[300px] bg-white/50 dark:bg-slate-900/60 border border-slate-200 dark:border-white/5 rounded-3xl flex flex-col gap-4 p-5 md:p-6 translate-y-[-10px] md:translate-y-[-20px] z-0">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 pb-24 w-full">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          ...
          {[
            ...
            <div key={idx} className="glass-panel stat-card p-8 text-left backdrop-blur-xl bg-white/80 dark:bg-slate-900/50">
