  ...
  return (
    <div className="animate-[fadeIn_0.5s_ease-out] w-full">
      <header className="mb-8">
        ...
        <p className="text-slate-400 text-sm">Monitor core nodes and audit access logs.</p>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="glass-panel stat-card p-6">
          <div className="flex justify-between items-center mb-4">
            <h4 className="text-slate-400 text-xs font-semibold">Total Users</h4>
            <Users size={20} className="text-indigo-400" />
          </div>
          <p className="text-4xl font-extrabold text-indigo-400">1,240</p>
          <p className="text-xs text-slate-400 mt-1">+12 today</p>
        </div>

        <div className="glass-panel stat-card p-6">
          <div className="flex justify-between items-center mb-4">
            <h4 className="text-slate-400 text-xs font-semibold">Active Doctors</h4>
            <ShieldCheck size={20} className="text-emerald-400" />
          </div>
          <p className="text-4xl font-extrabold text-emerald-400">45</p>
          <p className="text-xs text-slate-400 mt-1">3 on duty</p>
        </div>

        <div className="glass-panel stat-card p-6">
          <div className="flex justify-between items-center mb-4">
            <h4 className="text-slate-400 text-xs font-semibold">System Health</h4>
          ...
          <p className="text-xs text-slate-400 mt-1">0 incidents</p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="glass-panel lg:col-span-2 p-6 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2">
                {[
                  ...
                  <div key={idx} className="flex items-center justify-between p-3 bg-slate-800/20 rounded-xl border border-white/5 hover:bg-slate-800/40 transition-all duration-200">
                    <div>
                      <h4 className="font-medium text-slate-200 text-sm">{log.event}</h4>
            ...
            <div className="glass-panel p-6 flex flex-col gap-4 h-fit">
              ...
              <div className="mt-2 p-4 bg-indigo-500/5 text-indigo-300 rounded-xl border border-indigo-500/10 text-xs">
                ...
                <p className="text-slate-400">{data?.message || "Node online."}</p>
              </div>
            </div>
          </div>
        )}
