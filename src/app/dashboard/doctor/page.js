    ...
    <div className="animate-[fadeIn_0.5s_ease-out] w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="glass-panel stat-card p-6">
          ...
          <p className="text-xs text-slate-600 dark:text-slate-400 mt-1">4 remaining</p>
        </div>
        ...
        <div className="glass-panel stat-card p-6">
          ...
          <p className="text-xs text-slate-600 dark:text-slate-400 mt-1">Sarah Jenkins</p>
        </div>
      </div>
            ...
            <div className="glass-panel lg:col-span-2 p-6 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3">
                {[
                  ...
                  <div key={idx} className="flex items-center justify-between p-4 bg-slate-200/50 dark:bg-slate-800/30 rounded-xl border border-slate-200 dark:border-white/5 hover:bg-slate-800/50 transition-all duration-200">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600 dark:text-slate-400 text-xs">{patient.type}</p>
                      </div>
                    </div>
