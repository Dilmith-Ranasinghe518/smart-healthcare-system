  ...
  return (
    <div className="animate-[fadeIn_0.5s_ease-out] w-full">
      <header className="mb-8">
        ...
        <p className="text-slate-400 text-sm">Monitor your vitals and upcoming appointments below.</p>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="glass-panel stat-card p-6">
          <div className="flex justify-between items-center mb-4">
            <h4 className="text-slate-400 text-xs font-semibold">Heart Rate</h4>
        ...
        <div className="glass-panel stat-card p-6">
          <div className="flex justify-between items-center mb-4">
            <h4 className="text-slate-400 text-xs font-semibold">Blood Pressure</h4>
        ...
        <div className="glass-panel stat-card p-6">
          <div className="flex justify-between items-center mb-4">
            <h4 className="text-slate-400 text-xs font-semibold">Sleep Score</h4>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="glass-panel lg:col-span-2 p-6 flex flex-col gap-4">
              ...
              <h4 className="mt-2 text-sm font-semibold flex items-center gap-2">
                <Calendar size={18} className="text-slate-400" /> Upcoming Activities
              </h4>
              <p className="text-slate-400 text-sm">0 Upcoming Appointments.</p>
            </div>
